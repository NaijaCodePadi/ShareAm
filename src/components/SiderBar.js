  ...
  <aside>
        <nav class="sidebar-nav">
          ...
          <div class="nav-link-container">
            ...
            <a class="menu-link nav-texts" href="../settings/profile.html">
              <span>
                <svg
                  width="19"
                  height="18"
            ...
            <a class="menu-link nav-texts" href="../dashboard/view.html">
              <span>
                <svg
                  width="19"
                  height="15"
            ...
            <a class="menu-link nav-texts" href="../messages/list.html">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
            ...
            <a class="menu-link nav-texts" href="../dashboard/calendar.html">
              <span>
                <svg
                  width="20"
                  height="20"
            ...
            <a class="menu-link nav-texts" href="../settings/notification.html">
              <span>
                <svg
                  width="21"
                  height="22"
            ...
            <a class="menu-link nav-texts" href="../settings/settings.html">
              <span>
                <svg
                  width="22"
                  height="23"
...
class SideBar extends HTMLElement {
  constructor() {
    ...
    // this.activeMenu = shadowRoot.querySelectorAll(".menu-link");
    // this.menuActive = this.menuActive.bind(this);
    // this.activeMenu.forEach((child) =>
    //   child.addEventListener("click", this.menuActive)
    // );
  }
  ...
  //   this.activeMenu.forEach((child) => {
  //     if (child.classList.contains("active-menu")) {
  //       child.classList.remove("active-menu");
